...
import TextSelectionAnalogy from '@/components/TextSelectionAnalogy';
...
type BiologyResult = BiologyTopicResult;
  ...
  if (currentView === 'learning' && biologyResults.length > 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream-50 via-cream-100 to-cream-200">
        ...
        {/* AI ChatBot in learning view */}
        <ChatBot 
          isOpen={isChatBotOpen} 
          onToggle={() => setIsChatBotOpen(!isChatBotOpen)} 
        />
        
        {/* Text Selection Analogy Popup in learning view */}
        {selection && (
          <div data-analogy-popup>
            <TextSelectionAnalogy
